...
AShooterCharacter::AShooterCharacter() :
	...
	bAiming(false),
	// Mouse loo sensitivity scale factors
	...
	HighlightedSlot(-1)
{
	...
	CameraBoom->TargetArmLength = 180; // The camera follows at this distance behind the character
...
void AShooterCharacter::BeginPlay()
{
	...
	// Spawn th default weapon and equip it
...
void AShooterCharacter::CalculateCrosshairSpread(float DeltaTime)
{
	...
	{
		// Spread the crosshairs back to normal very quickly 
		CrosshairAimFactor = FMath::FInterpTo(CrosshairAimFactor, 0.f, DeltaTime, 30.f);
	}

	// True 0.05 seconnds after firing
	if (bFiringBullet)
	{
...
void AShooterCharacter::TraceForItems()
{
	if (bShouldTraceForItems)
	{
		...
		if (ItemTraceResult.bBlockingHit)
		{
			...
			//AItem* HitItem = ItemTraceResult.GetActor(); for UE5
...
void AShooterCharacter::InterpCapsuleHalfHeight(float DeltaTime)
{
	...
	const float DeltaCapsulHalfHeight{ InterpHalfHeight - GetCapsuleComponent()->GetScaledCapsuleHalfHeight() };
	const FVector MeshOffset{ 0.f, 0.f, -DeltaCapsulHalfHeight };
